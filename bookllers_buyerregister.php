  ...
  <div class="form_wrapper">
	<div class="form_container">
		<div class="title_container">
			<h2>Buyer's Registration Form</h2>
		</div>
		<div class="row clearfix">
			<div class="">
				<form id='bookllers_buyerregister' autocomplete="off" action="bookllers_buyerregisterprocess.php" method="GET">
					<div class="row clearfix">
						<div class="col_half">
							<div class="input_field"> 
								...
								<input type="text" name="frstname" placeholder="First Name" required />
							</div>
						</div>
						<div class="col_half">
							<div class="input_field"> 
					...
					<div class="input_field"> 
						...
						<input type="text" name="cntact_no" placeholder="Contact No." required />
					</div>
					<div class="input_field"> 
						<textarea name="addrs" rows="3" style="width: 500px;max-width: 98%" placeholder="Write Address..." required /></textarea>
					</div>
					<div class="input_field"> 
          ...
          <div class="input_field"> 
            <input type="text" name="captcha" placeholder="Enter the captcha" required />
					...
					<div class="input_field"> 
          <img src="bookllers_captcha.php" width="95" height="50">
          </div>
