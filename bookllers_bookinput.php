  ...
  <div class="form_wrapper">
	<div class="form_container">
		...
		<div class="row clearfix">
			<div class="">
				<form id='bookllers_bookinput' autocomplete="off" action="bookllersbookprocess.php" method="POST" enctype="multipart/form-data">
					<div class="row clearfix">
						<div class="col_half">
          ...
          <div class="input_field"> 
            Catagory: <select name="catagory" required />
              <option value="Others">Others</option>
                ...
                <option value="Tutorials">Tutorials</option>
					...
					<div class="input_field">
						<input type="text" name="quantity" placeholder="In Stock" required />
					</div>
					<div class="input_field"> 
