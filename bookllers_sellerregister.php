  ...
  <div class="form_wrapper">
	<div class="form_container">
		<div class="title_container">
			<h2>Seller's Registration Form</h2>
		</div>
		<div class="row clearfix">
			<div class="">
				<form id='bookllers_sellerregister' autocomplete="off" action="bookllers_sellerregisterprocess1.php" method="GET">
					<div class="row clearfix">
						<div class="col_half">
					...
					<div class="input_field"> 
					Current Year: <select name="year" required />
					...
					<div class="input_field"> 
						...
						<input type="text" name="whatsapp_no" placeholder="Whatsapp No." required />
					</div>
					<div class="input_field"> 
