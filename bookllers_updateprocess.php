...
$flag=1;
   ...
   if (mysqli_num_rows($result) < 1) {
     $msg1= "<h3 style='color: red;'> You are not authorized seller of this book! Please select your own book only!</h3><h4 style='text-decoration:none;'><a href='bookllers.php'>Go Back</a></h4>";
   }
   else
        $flag=0;
  ...
  <div class="form_wrapper">
	<div class="form_container">
		...
		<div class="row clearfix">
			<div class="">
				<form id='bookllers_updateprocess' autocomplete="off" action="bookeditprocess3.php" method="POST">
					
					<div class="input_field"> 
						Price: <input type="text" name="price" value="<?php echo $row['prc'] ?>" required />
					</div>
					<div class="input_field"> 
						
						In Stock: <input type="text" name="quantity" value="<?php echo $row['qnty'] ?>" required />
					</div>
...
-->					<input name ='Submit' class="button" type="submit" value="Update" />
				</form>
				<?php
}
else
